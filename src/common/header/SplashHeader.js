						...
						<div className='header-main-nav'>
							...
							<nav className='mainmenu-nav'>
								<ul className='mainmenu'>
									...
									<li>
										<a href='#splsh-features'>Features</a>
									</li>
									<li>
										<a href='#splash-why-choose'>Why Us</a>
									</li>
									<li>
										<a href='https://new.axilthemes.com/docs/abstrak-react/'>Documentation</a>
									</li>
									<li>
										<a href='https://support.axilthemes.com/support/'>Support Ticket</a>
									</li>
								</ul>
							</nav>
							{/* End Mainmanu Nav */}
