		...
		<>
			...
			<main className='main-wrapper'>
				...
				<div className='section section-padding bg-color-light pb--70'>
					...
					<div className='container'>
						{detailsService.process.steps.map((data, index) => (
							<div
								key={index}
								className={`process-work ${index % 2 === 1 ? "content-reverse" : ""}`}>
					...
					<ul className='shape-group-17 list-unstyled'>
						<li className='shape shape-1'>
							<img src={process.env.PUBLIC_URL + "/images/others/bubble-24.png"} alt='Bubble' />
						</li>
						<li className='shape shape-2'>
							<img src={process.env.PUBLIC_URL + "/images/others/bubble-23.png"} alt='Bubble' />
						</li>
				...
				<div className='section section-padding'>
					<div className='container'>
						<SectionTitle
							subtitle='Mūsų projektai'
							title='Naujausi įgyvendinti projektai'
							description=''
							textAlignment=''
							textColor=''
						/>
