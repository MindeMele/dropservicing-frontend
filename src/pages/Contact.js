						...
						<div className='row'>
							<div className='col-xl-5 col-lg-6'>
								<div className='contact-form-box shadow-box mb--30'>
									<h3 className='title'>Susisiekti su DevCode komanda</h3>
									<FormTwo />
								</div>
							</div>
							<div className='col-xl-5 col-lg-6 offset-xl-1'>
								<div className='contact-info mb--100 mb_md--30 mt_md--0 mt--150'>
									<h4 className='title'>Telefono Numeris</h4>
									<p>Su mumis galime susisiekti darbo dienomis 8:00 - 17:00</p>
									<h4 className='phone-number'>
										<a href='tel:+37063057701'>+370 63057701</a>
									</h4>
								</div>
								<div className='contact-info mb--30'>
									<h4 className='title'>El. Paštas</h4>
									<p>DevCode komanda atsakymas jums el. paštu per 2 darbo dienas</p>
									<h4 className='phone-number'>
										<a href='mailto:hoodis.dev@gmail.com'>hoodis.dev@gmail.com</a>
									</h4>
								</div>
							</div>
						</div>
